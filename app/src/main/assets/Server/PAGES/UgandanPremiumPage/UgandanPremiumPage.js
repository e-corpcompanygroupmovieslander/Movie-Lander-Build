    ...
    DEJSON('local','UserData',(data)=>{
        ...
        DECLARATION('#UGDaily',(ELEMENT)=>{
            ...
            EVENT(ELEMENT,'click',()=>{
                ...
                PESAPAL(`https://e-corpcompanygroupmovieslander.github.io/MovieLanderApp/PAGES/PAYMENT%20SYSTEM/DailyPesaPal.html?MyData=${localStorage.getItem('User')}`,1000,'UGX',(data)=>{
        ...
        DECLARATION('#UGWeekly',(ELEMENT)=>{
            ...
            EVENT(ELEMENT,'click',()=>{
                ...
                PESAPAL(`https://e-corpcompanygroupmovieslander.github.io/MovieLanderApp/PAGES/PAYMENT%20SYSTEM/WeeklyPesaPal.html?MyData=${localStorage.getItem('User')}`,5000,'UGX',(data)=>{
        ...
        DECLARATION('#UGMonthly',(ELEMENT)=>{
            ...
            EVENT(ELEMENT,'click',()=>{
                ...
                PESAPAL(`https://e-corpcompanygroupmovieslander.github.io/MovieLanderApp/PAGES/PAYMENT%20SYSTEM/MonthlyPesaPal.html?MyData=${localStorage.getItem('User')}`,25000,'UGX',(data)=>{
        ...
        DECLARATION('#UGYearly',(ELEMENT)=>{
            ...
            EVENT(ELEMENT,'click',()=>{
                ...
                PESAPAL(`https://e-corpcompanygroupmovieslander.github.io/MovieLanderApp/PAGES/PAYMENT%20SYSTEM/YearlyPesaPal.html?MyData=${localStorage.getItem('User')}`,200000,'UGX',(data)=>{
