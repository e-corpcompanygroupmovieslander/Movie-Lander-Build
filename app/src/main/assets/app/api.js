...
const HELPTEXT=`https://e-corpcompanygroupmovieslander.github.io/Movie-Lander-Build/app/src/main/assets/DOCUMENTS/HelpPage/HelpPage.txt`;

const UPDATEAPI=`https://play.google.com/store/apps/details?id=com.movie_lander`;
...
const PARENTALCONTROLTEXT=`https://e-corpcompanygroupmovieslander.github.io/Movie-Lander-Build/app/src/main/assets/DOCUMENTS/ParentalControl/ParentalControl.txt`;
...
const WebsiteContact='https://www.e-corpcompanygroup.com';

const InstagramUserName='e_corpcompanygroup';

const GmailLink='movielander1999@gmail.com';

const COUNTRYAPI='./countriesapi.json';
...
const UGDAILY='1000';
const UGWEEKLY='5000';
const UGMONTHLY='20000';
const UGYEARLY='200000';
...
const UPDATEMESSAGE=`
    ...
    Get Access To Latest Features And Bug Fixs Of Movie Lander.
...
if (localStorage.getItem('Environment') === 'Production' ) {
    ...
    if (navigator.onLine ) {
        ...
        HOMEPAGEAPI='https://e-corpcompanygroupmovieslander.github.io/Movie-Lander-Build/app/src/main/assets/Server/PAGES/HomePage/HomePage.txt'
